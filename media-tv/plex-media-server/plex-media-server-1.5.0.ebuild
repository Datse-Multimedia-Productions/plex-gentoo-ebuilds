...
#
# 1.5.0.3501-3b8374a5c_amd64.deb
# March 17, 2017
# https://downloads.plex.tv/plex-media-server/1.5.0.3501-3b8374a5c/plexmediaserver_1.5.0.3501-3b8374a5c.deb
#

EAPI="2"
inherit eutils user

# https://downloads.plex.tv/plex-media-server/1.5.0.3501-3b8374a5c/plexmediaserver_1.5.0.3501-3b8374a5c_amd64.deb
MAGIC="3501-3b8374a5c"
URI_PRE="https://downloads.plex.tv/plex-media-server/${PV}.${MAGIC}/plexmediaserver_${PV}.${MAGIC}_"

DESCRIPTION="Plex Media Server is a free media library."
